(function ($) {
    ...
    swiperslider.each(function () {
        ...
        if (columns === 1 || columns == 1.8) {
            ...
            var responsive_items = [columns, "4", "2", "2", "1"];
        } else if (columns === 5) {
            var responsive_items = ["5", "4", "2", "2", "1"];
        } else if (columns === 6) {
            var responsive_items = ["6", "4", "2", "2", "1"];
        } else {
        ...
        if (val_dots === true) {
            pagination_val = { el: ".swiper-pagination", clickable: true };
        }
        ...
        if (carouselElement.hasClass("marquee")) {
            ...
            var swiper2 = new Swiper(".pbmit-element-viewtype-carousel-" + x, {
                ...
                centeredSlides: true,
                speed: 5000,
                autoplay: { delay: 1, disableOnInteraction: true, reverseDirection: reverse_direction },
                loop: true,
                slidesPerView: "auto",
    ...
    $(".pbmit-circle-outer").each(function () {
        ...
        if (typeof $.fn.circleProgress === "function") {
            ...
            $(".pbmit-circle", this_circle)
                .circleProgress({ value: 0, size: size_val, startAngle: (-Math.PI / 4) * 2, thickness: thickness_val, emptyFill: emptyFill_val, fill: fill_val })
